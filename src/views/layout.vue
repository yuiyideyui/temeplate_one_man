<template>
  <div id="mainBox">
    ...
    <div class="footer-button">
      <MultiButton v-for="(button, index) in footButton" :key="index" class="test" :layerList="button.layerList"
        :defaultImage="button.defaultImage" :selectImage="button.selectImg" :comTitle="button.comTitle"
...
// 动态生成图片路径
const getImageUrl = (path:any) => new URL(`../assets/image/${path}`, import.meta.url).href;
